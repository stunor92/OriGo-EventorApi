...
class ResultListConverter {
    ...
    fun convertEventResultList(eventor: Eventor, resultList: ResultList): List<EventorCompetitor> {
    ...
    @Throws(NumberFormatException::class, ParseException::class)
    private fun convertOneDayPersonResult(eventor: Eventor, event: Event, classResult: org.iof.eventor.ClassResult, personResult: org.iof.eventor.PersonResult): EventorCompetitor {
    ...
    private fun convertMultiDayPersonResult(
        ...
        raceResult: org.iof.eventor.RaceResult): EventorCompetitor {
        return EventorPersonCompetitor(
    ...
    fun convertTeamMembers(eventor: Eventor, teamMembers: List<org.iof.eventor.TeamMemberResult>): List<EventorTeamMemberCompetitor> {
    ...
    @Throws(ParseException::class)
    private fun convertTeamMember(eventor: Eventor, teamMember: org.iof.eventor.TeamMemberResult): EventorTeamMemberCompetitor {
